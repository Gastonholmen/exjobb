...
\end{equation}
for $d=0,...,13$. With this definition, the downsampled radar sweeps consist of 14 evenly spaced range indices from ranges 9.4 to 21.88 cm. Thus, the resulting data matrix used for generating one set of features has $14\cdot 2$ complex ranges for the two sensors and $T=25$ slow time sweeps. 
