...
\begin{figure}[h]
	...
	\caption{The plot shows the average sweep energy for 200 sweeps and four different materials. All measurements were made on the same day. The reflections from the grass surface carry noticeably less energy than the other surfaces, making this a good feature for binary grass/not grass classification. }
