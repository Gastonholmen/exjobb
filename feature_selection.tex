...
After having chosen to proceed with feature configuration 2 in table \ref{tab:feat}, the 175 dimensions can be reduced to 2 dimensions using \gls{pca}. This helps to visualize the separability of the different materials as seen in figure \ref{fig:pca}.
