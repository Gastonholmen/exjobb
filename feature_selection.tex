...
The bias in this estimate is completely inconsequential as all features later are normalized to zero mean unit variance. Estimating the autocovariances through \eqref{eq:ac} does assume that $x(n,t)$ is wide sense stationary. This can not always be guaranteed in practice, however, but the estimates may nevertheless be used as a measure for distinguishing between surfaces. We may form features as
\begin{equation}
	\hat{\mathbf{r}}_{k} = 
	\begin{bmatrix}
