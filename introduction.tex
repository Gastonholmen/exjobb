...
In terms of software, Python will be utilized together with Scikit learn as well as Keras running on top of TensorFlow for additional machine learning support. 
